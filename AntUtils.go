...
func GetAtomByString(a string) atom.Atom {
	...
	switch a {
	case "A":return atom.A
	case "Abbr":return atom.Abbr
	case "Accept":return atom.Accept
	case "AcceptCharset":return atom.AcceptCharset
	case "Accesskey":return atom.Accesskey
	case "Action":return atom.Action
	case "Address":return atom.Address
	case "Align":return atom.Align
	case "Alt":return atom.Alt
	case "Annotation":return atom.Annotation
	case "AnnotationXml":return atom.AnnotationXml
	case "Applet":return atom.Applet
	case "Area":return atom.Area
	case "Article":return atom.Article
	case "Aside":return atom.Aside
	case "Async":return atom.Async
	case "Audio":return atom.Audio
	case "Autocomplete":return atom.Autocomplete
